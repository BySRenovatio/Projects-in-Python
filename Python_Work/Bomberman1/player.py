...
class PygamePlayer(Player):
    ...
    def __init__(self, screen, position, direction, player_image, tiles_per_direction=3,
                 tiles_width=16, tiles_height=16):
    ...
    def __load_image(self, start):
        images = list()
        for i in range(start, start + self.__tiles_per_direction):

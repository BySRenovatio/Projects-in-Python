class Bomb(object):
    ...
    def __init__(self, position, rang):
...
class PygameBombModel:
    ...
    def __init__(self, bomb_image, explosion_image, tiles=1, tiles_per_direction=1, tiles_width=16, tiles_height=16):
        ...
        self.explosion_tiles = [self.__load_explosion_image(0), self.__load_explosion_image(1),
                                self.__load_explosion_image(2), self.__load_explosion_image(3),
                                self.__load_explosion_image(4, 1)]
...
class PygameBomb(Bomb):
    ...
    def __init__(self, screen, model, position, rang):
        super(PygameBomb, self).__init__(position, rang)
